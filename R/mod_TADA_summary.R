  ...
  moduleServer(id, function(input, output, session) {
    ...
    shiny::observeEvent(input$disclaimer, {
      shiny::showModal(shiny::modalDialog(
        ...
        shiny::tags$ul(
          shiny::tags$li(
            "This module is still under development, and new feature additions are being added."
          ),
          shiny::tags$li(
            ...
            shiny::tags$ul(
              ...
              shiny::tags$li(
                "Magnitude Columns: MagnitudeValueLower, MagnitudeValueUpper, and MagnitudeUnit"
              ),
              shiny::tags$li(
                "Duration Columns: DurationValue, DurationUnit, DurationMethod"
              ),
