...
criteria_table <- read_excel("Data/TADA_Format_Criteria_Table_DRAFT_20250717.xlsx", 
...
hardness_equation <- read_excel("Data/TADA_Format_Criteria_Table_DRAFT_20250717.xlsx",
                                sheet = "Hardness_eq")

# Equation based on pH and hardness
pH_Hardness_equation <- read_excel("Data/TADA_Format_Criteria_Table_DRAFT_20250717.xlsx",
                                   sheet = "pH_Hardness_eq")

# Equation based on pH
pH_equation <- read_excel("Data/TADA_Format_Criteria_Table_DRAFT_20250717.xlsx",
                          sheet = "pH_eq")

# Equation based on pH and Temperature
pH_Temperature_equation <- read_excel("Data/TADA_Format_Criteria_Table_DRAFT_20250717.xlsx",
